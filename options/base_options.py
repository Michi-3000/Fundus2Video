...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--temp_loss', default=0)
        #self.parser.add_argument('--lambda_NCE', type=float, default=1.0, help='weight for NCE loss: NCE(G(X), X)')
        #self.parser.add_argument('--lambda_asp', type=float, default=0., help='weight for ASP_NCE loss')
        ...
        self.parser.add_argument('--lambda_NCE', type=float, default=1.0, help='weight for NCE loss: NCE(G(X), X)')
        self.parser.add_argument('--lambda_asp', type=float, default=0., help='weight for ASP_NCE loss')
        self.parser.add_argument('--nce_idt', type=util.str2bool, nargs='?', const=True, default=False, help='use NCE loss for identity mapping: NCE(G(Y), Y))')
